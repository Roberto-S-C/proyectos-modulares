...
import { CreateFileType, MAX_FILE_SIZE, UpdateFileType } from "../types/file.type";
...
export const createFileType = (fileType: CreateFileType) => apiClient.post(`/filetypes`, fileType);
